...
class MaintenanceMenu:
    ...
    def backup_menu(self):
        ...
        directory.add_file('[Restore]: URL Build', {'mode': 'restore', 'action': 'build', 'name': 'url'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        directory.add_file('[Restore]: URL GuiFix', {'mode': 'restore', 'action': 'gui', 'name': 'url'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
